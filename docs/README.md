...
* [知识点](machine-learning/tips/tips.md)
  ...
  * [学习率](machine-learning/tips/learning-rate/learning-rate.md)
    * [学习率和BatchSize的关系](machine-learning/tips/learning-rate/learning-rate-and-batch-size/learning-rate-and-batch-size.md)
    * [余弦退火和余弦重启](machine-learning/tips/learning-rate/cosine-annealing-warm-restarts/cosine-annealing-warm-restarts.md)
