...
* [梯度更新算法](mathematics/gradient-update-algorithm/gradient-update-algorithm.md)
  * [离线学习](mathematics/gradient-update-algorithm/offline-learning/offline-learning.md)
    ...
    * [随机梯度下降SGD](mathematics/gradient-descent-algorithm/sgd/sgd.md)
    * [动量法Momentum](mathematics/gradient-descent-algorithm/momentum/momentum.md)
    * [牛顿动量Nesterov](mathematics/gradient-descent-algorithm/nesterov/nesterov.md)
    * [AdaGrad](mathematics/gradient-descent-algorithm/adagrad/adagrad.md)
    * [RMSprop](mathematics/gradient-descent-algorithm/rmsprop/rmsprop.md)
    * [Adadelta](mathematics/gradient-descent-algorithm/adadelta/adadelta.md)
    * [Adam](mathematics/gradient-descent-algorithm/adam/adam.md)
    * [Nadam](mathematics/gradient-descent-algorithm/nadam/nadam.md)
    * [AMSGrad](mathematics/gradient-descent-algorithm/amsgrad/amsgrad.md)
    * [AdasMax](mathematics/gradient-descent-algorithm/adamax/adamax.md)
  * [在线学习](mathematics/gradient-update-algorithm/online-learning/online-learning.md)
    * [FTRL](mathematics/gradient-update-algorithm/online-learning/online-learning/FTRL/FTRL.md)
