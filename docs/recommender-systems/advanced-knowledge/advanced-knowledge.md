...
* [排序模型概述](rank-model-introduction/rank-model-introduction.md)
* [召回模型概述](recall-model-introduction/recall-model-introduction.md)
...
* [DNN深化](deepening-dnn/deepening-dnn.md)
* [特征交叉](feature-cross/feature-cross.md)
